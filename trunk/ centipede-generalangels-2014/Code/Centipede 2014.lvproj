...
DirectoryIndex index.htm
		...
		<Item Name="Systems" Type="Folder">
			<Item Name="Drive" Type="Folder">
				...
				<Item Name="Drive Axis Modifications.vi" Type="VI" URL="../Systems/Drive/Drive Axis Modifications.vi"/>
				<Item Name="Drive Get.vi" Type="VI" URL="../Systems/Drive/Drive Get.vi"/>
				<Item Name="Drive Read Encoders.vi" Type="VI" URL="../Systems/Drive/Drive Read Encoders.vi"/>
				<Item Name="Drive Problem Fix.vi" Type="VI" URL="../Systems/Drive/Drive Problem Fix.vi"/>
				<Item Name="Drive Finish.vi" Type="VI" URL="../Drive Finish.vi"/>
				<Item Name="Fix Rpm.vi" Type="VI" URL="../Fix Rpm.vi"/>
				<Item Name="Joy To Rpm.vi" Type="VI" URL="../Joy To Rpm.vi"/>
			</Item>
			<Item Name="Intake" Type="Folder">
				...
				<Item Name="Intake Finish.vi" Type="VI" URL="../Intake Finish.vi"/>
			</Item>
			<Item Name="Cannon" Type="Folder">
				...
				<Item Name="Cannon Sensors Update.vi" Type="VI" URL="../Systems/Cannon/Cannon Sensors Update.vi"/>
				<Item Name="Cannon Set.vi" Type="VI" URL="../Systems/Cannon/Cannon Set.vi"/>
				<Item Name="Cannon Lock Fire.vi" Type="VI" URL="../Systems/Cannon/Cannon Lock Fire.vi"/>
				<Item Name="Cannon Arming.vi" Type="VI" URL="../Systems/Cannon/Cannon Arming.vi"/>
				<Item Name="Cannon Process.vi" Type="VI" URL="../Systems/Cannon/Cannon Process.vi"/>
				<Item Name="Cannon Fix.vi" Type="VI" URL="../Systems/Cannon/Cannon Fix.vi"/>
				<Item Name="Cannon Get.vi" Type="VI" URL="../Systems/Cannon/Cannon Get.vi"/>
				<Item Name="Cannon Stow.vi" Type="VI" URL="../Systems/Cannon/Cannon Stow.vi"/>
				<Item Name="Cannon Angle Calculator.vi" Type="VI" URL="../Systems/Cannon/Cannon Angle Calculator.vi"/>
				<Item Name="Cannon Finish.vi" Type="VI" URL="../Cannon Finish.vi"/>
			</Item>
			<Item Name="Camera" Type="Folder">
				<Item Name="Camera Set.vi" Type="VI" URL="../Systems/Camera/Camera Set.vi"/>
				<Item Name="Camera Global.vi" Type="VI" URL="../Systems/Camera/Camera Global.vi"/>
				<Item Name="Camera Begin.vi" Type="VI" URL="../Systems/Camera/Camera Begin.vi"/>
				<Item Name="Camera Get.vi" Type="VI" URL="../Systems/Camera/Camera Get.vi"/>
				<Item Name="Camera Angle Calc.vi" Type="VI" URL="../Systems/Camera/Camera Angle Calc.vi"/>
				<Item Name="Camera Finish.vi" Type="VI" URL="../Camera Finish.vi"/>
			</Item>
			<Item Name="Oriantation" Type="Folder">
				<Item Name="Oriantation Begin.vi" Type="VI" URL="../Systems/Orientation/Oriantation Begin.vi"/>
				<Item Name="Oritentation Global.vi" Type="VI" URL="../Systems/Orientation/Oritentation Global.vi"/>
				<Item Name="Oriantation Update.vi" Type="VI" URL="../Systems/Orientation/Oriantation Update.vi"/>
				<Item Name="Oriantation Calculation.vi" Type="VI" URL="../Systems/Orientation/Oriantation Calculation.vi"/>
				<Item Name="Oriantation Problem Fix.vi" Type="VI" URL="../Systems/Orientation/Oriantation Problem Fix.vi"/>
				<Item Name="Oriantation Process.vi" Type="VI" URL="../Systems/Orientation/Oriantation Process.vi"/>
				<Item Name="Oriantation Finish.vi" Type="VI" URL="../Oriantation Finish.vi"/>
			</Item>
		</Item>
		<Item Name="VI Toolkit" Type="Folder">
			...
			<Item Name="Auto Drive Distance.vi" Type="VI" URL="../VI Toolkit/Auto Drive Distance.vi"/>
			<Item Name="Auto Rotate By Gyro.vi" Type="VI" URL="../VI Toolkit/Auto Rotate By Gyro.vi"/>
			<Item Name="Auto Rotation.vi" Type="VI" URL="../VI Toolkit/Auto Rotation.vi"/>
			<Item Name="Begin-Encoder.vi" Type="VI" URL="../VI Toolkit/Begin-Encoder.vi"/>
			<Item Name="Begin-Motor+Potentometer.vi" Type="VI" URL="../VI Toolkit/Begin-Motor+Potentometer.vi"/>
			<Item Name="Button To Toggle Vr3.vi" Type="VI" URL="../VI Toolkit/Button To Toggle Vr3.vi"/>
			<Item Name="Button To Toggle Vr4.vi" Type="VI" URL="../VI Toolkit/Button To Toggle Vr4.vi"/>
			...
			<Item Name="GetCurrentAvg.vi" Type="VI" URL="../VI Toolkit/GetCurrentAvg.vi"/>
			...
			<Item Name="Rad2Pos.vi" Type="VI" URL="../VI Toolkit/Rad2Pos.vi"/>
			<Item Name="RealFlight Controller Layout.vi" Type="VI" URL="../VI Toolkit/RealFlight Controller Layout.vi"/>
			...
			<Item Name="Simple Auto-Shifter.vi" Type="VI" URL="../VI Toolkit/Simple Auto-Shifter.vi"/>
			...
			<Item Name="Vector to cartez.vi" Type="VI" URL="../VI Toolkit/Vector to cartez.vi"/>
			<Item Name="Slow drive.vi" Type="VI" URL="../VI Toolkit/Slow drive.vi"/>
			<Item Name="Camera Servo Control by Joystick.vi" Type="VI" URL="../VI Toolkit/Camera Servo Control by Joystick.vi"/>
			<Item Name="Acceleration.vi" Type="VI" URL="../VI Toolkit/Acceleration.vi"/>
		</Item>
		<Item Name="Special" Type="Folder">
			<Item Name="Human Interface.vi" Type="VI" URL="../Special/Human Interface.vi"/>
			<Item Name="Xbox Layout.vi" Type="VI" URL="../Special/Xbox Layout.vi"/>
			<Item Name="Joystick Global.vi" Type="VI" URL="../Joystick Global.vi"/>
			<Item Name="General Begin.vi" Type="VI" URL="../Special/General Begin.vi"/>
		</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Bld_localDestDir" Type="Path">/C/Users/Peleg/Desktop/2014 Final/Builds</Property>
